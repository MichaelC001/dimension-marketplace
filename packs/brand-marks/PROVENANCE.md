...
- **The marks it renders** (X, Reddit, YouTube, Discord) are **trademarks of their
  owners**. They are NOT licensed by the MIT licence, and this pack implies no
...
field), cross-checked against a web search on 2026-09-25.
...
3. **No implied endorsement.** The pack is a community presentation; it is not made,
   sponsored or approved by X Corp., Reddit, Inc., Google LLC or Discord Inc.
