// the environment card, shipped AS A PACK.
//
// There is no reimplementation here, and that is the point. `ENVIRONMENT_CLASSIC` is
...
//
// PROVEN, not assumed: a wrapper carrying `data-probe-pack="classic-environment"` was built
...
export const implementation = ENVIRONMENT_CLASSIC;

/** The bundle contract (doc 68 §16.2): the host takes the default export. */
export default ENVIRONMENT_CLASSIC.component;
