// the session rail, shipped AS A PACK.
//
// There is no reimplementation here, and that is the point. `RAIL_CLASSIC` is
...
//
// PROVEN, not assumed: a wrapper carrying `data-probe-pack="classic-rail"` was built
...
export const implementation = RAIL_CLASSIC;

/** The bundle contract (doc 68 §16.2): the host takes the default export. */
export default RAIL_CLASSIC.component;
